...
public class CustomerHandler {
    ...
    // TODO: 20.11.2018 убрать дублирование кода
    public void returnProductFromBasket(RemoveProductListener removeProductListener) {
    ...
    // TODO: 20.11.2018 убрать дублирование кода
    public void returnProductFromBasket(Pair<Product, Integer> product, RemoveProductListener removeProductListener) {
        if (!customer.getBasket().getProducts().isEmpty()) {
    ...
    public void returnAllProductFromBasket(RemoveProductListener removeProductListener) {
        while (!customer.getBasket().getProducts().isEmpty()) {
            returnProductFromBasket(removeProductListener);
        }
    }

    public void payForProducts(Bill bill) {
        if (!customer.getBasket().getProducts().isEmpty()) {
            System.out.println("bill: " + bill.getProducts().size());
